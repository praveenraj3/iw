...
<body><?php include_once("analyticstracking.php") ?>
    ...
    <div id="page" class="push">
        ...
        <div class="container main-wrap">
            <div class="big-text01 text-center wow fadeInUp animated">Who we are<span style="color: #eb1c24;">.</span>
            </div>
        ...
        <div class="container-fluid contact">
            <div class="row cnt-row">
                <div class="col-md-6 about-left">
                    <div class="table-t">
                        <div class="cell text-center wow fadeInUp">
                            <h1>
        ...
        <div class="container-fluid creativeCouncil-wrap text-center">
            <p class="quote wow fadeInLeft"><strong style="color: #ec1c24; font-family: serif;">"</strong>Our Creative council team is the ones who know the way,
                <br class="visible-md visible-lg">goes the way and shows the way – Forward<strong style="color: #ec1c24; font-family: serif;">"</strong>
            </p>
            <div class="container">
                <div class="row">
