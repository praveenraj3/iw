...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>What We do - Indian Westeros</title>
...
<!--    <div class="container" id="serviceIcon">
        <div class="row">
            ...
            <div class="col-md-3 text-center">
                <a href="#creative-design"><img src="img/creative-icon.jpg" alt=""><br><span>CREATIVE DESIGN</span></a>
            </div>
            <div class="col-md-3 text-center">
                <a href="#branding"><img src="img/branding-icon.jpg" alt=""><br><span>BRANDING</span></a>
            </div>
            <div class="col-md-3 text-center">
...
<div class="container-fluid service two" id="strategy">
    <div class="container">
        <div class="row">
            <div class="col-md-12  strategy-content">
                <div class="table-t">
                    <div class="table-cell">
